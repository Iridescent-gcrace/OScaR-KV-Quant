...
def _should_pad_qpack_outputs(
    ...
    # 2-bit k-channel qpack can overrun the last output tile slightly on long CUDA prefill paths.
    # Route those calls through a padded temporary buffer and copy the valid region back out.
    return (
        k_cache.is_cuda
        and k_cache.dim() == 4
