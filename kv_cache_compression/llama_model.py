"""
Oscar KV Cache Quantization — LLaMA attention forward.
Compatible with transformers >= 4.45 (new LlamaAttention API).
"""
...
def llama_attention_forward_oscar(
    self,
    ...
    **kwargs,
    ...
    """
    Oscar KV cache quantization for LLaMA backbone (eager attention).
